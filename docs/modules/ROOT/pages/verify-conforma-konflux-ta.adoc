...
+
*Default*: `3s`
*ENABLE_VSA* (`string`):: Enable VSA generation
+
*Default*: `false`
*ATTESTATION_FORMAT* (`string`):: Attestation format: dsse (signed envelope) or predicate (raw JSON)
+
*Default*: `dsse`
...
*VSA_GENERATED*:: Whether VSAs were generated (true/false)
*sourceDataArtifact*:: Trusted Artifact URI containing VSA files
