...
func ComputeInfo() (*VersionInfo, error) {
	...
	info.Components = append(info.Components, dependencyVersion("ECC", "github.com/conforma/crds/api", buildInfo.Deps))
	...
	info.Components = append(info.Components, dependencyVersion("Cosign", "github.com/sigstore/cosign/v3", buildInfo.Deps))
